...
def generate_closed_walk(graph, start, steps=6):
    ...
    return walk
print("\nGRAPH (a)")
cycle1 = find_cycle(G1, 'A')
if cycle1:
    print("Closed Path =", print_path(G1, cycle1))
    print("Closed Trail =", print_path(G1, cycle1))
walk_a = generate_closed_walk(G1, 'A')
print("Closed Walk =", print_path(G1, walk_a))
print("\nGRAPH (b)")
cycle2 = find_cycle(G2, 'A')
if cycle2:
    print("Closed Path =", print_path(G2, cycle2))
    print("Closed Trail =", print_path(G2, cycle2))
